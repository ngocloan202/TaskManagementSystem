                ...
                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="bg-white rounded-lg shadow p-6 mb-6">
                        <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 mb-6">
                            <!-- Tìm kiếm -->
                            <form class="w-full md:w-auto flex items-center" method="GET">
                                <div class="relative w-full md:w-80">
                                    <input type="text" name="search" placeholder="Tìm kiếm người dùng..." value="<?= htmlspecialchars($search) ?>"
                                        class="pl-10 pr-4 py-2 rounded-lg w-full focus:outline-none border border-gray-300 focus:border-indigo-500">
