  ...
  <body class="bg-gray-100 flex items-center justify-center h-screen p-4">
    ...
    <div class="fixed inset-0 bg-black bg-opacity-20 flex items-center justify-center">
      ...
      <div class="bg-white rounded-2xl shadow-xl w-full max-w-md">
        ...
        <!-- Body -->
        <form class="px-6 pb-6 pt-4 space-y-4">
          <!-- Tên nhiệm vụ -->
          <div
          ...
          <div>
            ...
            <div class="flex space-x-3 mt-2">
              <button
                type="button"
                class="w-8 h-8 bg-pink-500 rounded-full border-2 border-gray-800 focus:outline-none"
              ></button>
              <button
                type="button"
                class="w-8 h-8 bg-red-600 rounded-full border-2 border-gray-800 focus:outline-none"
              ></button>
              <button
                type="button"
                class="w-8 h-8 bg-green-500 rounded-full border-2 border-gray-800 focus:outline-none"
              ></button>
              <button
                type="button"
                class="w-8 h-8 bg-blue-400 rounded-full border-2 border-gray-800 focus:outline-none"
              ></button>
              <button
                type="button"
                class="w-8 h-8 bg-orange-500 rounded-full border-2 border-gray-800 focus:outline-none"
              ></button>
            </div>
          </div>
