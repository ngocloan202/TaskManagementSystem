...
INSERT INTO Task (TaskTitle, TaskDescription, TaskStatusID, Priority, StartDate, EndDate, ProjectID, ParentTaskID, Label) VALUES
('Thiết lập cấu trúc thư mục PHP', '', 1, 'Cao', '2023-01-12 08:00:00', '2023-01-20 17:00:00', 1, NULL, 'Backend'),
('Thiết kế cơ sở dữ liệu', 'Thiết kế cấu trúc cơ sở dữ liệu cho hệ thống', 2, 'Cao', '2023-01-21 08:00:00', '2023-01-30 17:00:00', 1, 1, 'Database'),
('Phát triển giao diện người dùng', 'Xây dựng giao diện người dùng theo bản thiết kế', 2, 'Trung Bình', '2023-02-01 08:00:00', '2023-02-15 17:00:00', 1, 1, 'Frontend'),
('Viết giao diện Form đăng nhập', 'Thực hiện kiểm thử toàn bộ hệ thống', 1, 'Cao', '2023-02-20 08:00:00', '2023-03-01 17:00:00', 1, NULL, 'UI'),
('Thiết kế giao diện website', 'Thiết kế giao diện cho website bán hàng', 2, 'Trung Bình', '2023-02-16 08:00:00', '2023-02-28 17:00:00', 2, NULL, 'UI'),
('Xây dựng module thanh toán', 'Phát triển module thanh toán trực tuyến', 1, 'Khẩn cấp', '2023-03-01 08:00:00', '2023-03-15 17:00:00', 2, 5, 'Backend'),
('Cấu hình môi trường PHP', 'Cài đặt PHP, Apache, MySQL', 1, 'Trung Bình', '2023-01-12 09:00:00', '2023-01-13 17:00:00', 1, 1, 'WIP'),
('Tạo file cấu hình', 'Tạo file config cho project', 1, 'Thấp', '2023-01-13 08:00:00', '2023-01-14 17:00:00', 1, 1, 'Backend');
...
INSERT INTO Task (TaskTitle, TaskDescription, TaskStatusID, Priority, StartDate, EndDate, ProjectID, ParentTaskID, Label) VALUES
  ('Hoàn tất kiểm thử unit', 'Viết unit test cho các module chính', 3, 'Trung Bình', '2023-02-25 08:00:00', '2023-03-05 17:00:00', 1, NULL, 'Testing'),
  ('Triển khai môi trường staging', 'Deploy code lên server staging', 3, 'Cao', '2023-03-06 08:00:00', '2023-03-07 17:00:00', 1, NULL, 'DevOps'),
  ('Kiểm thử tích hợp', 'Test end-to-end toàn bộ luồng nghiệp vụ', 3, 'Khẩn cấp', '2023-03-08 08:00:00', '2023-03-10 17:00:00', 1, NULL, 'Testing');

-- Nếu bạn muốn thêm cho các project khác, chỉ cần đổi ProjectID
INSERT INTO Task (TaskTitle, TaskDescription, TaskStatusID, Priority, StartDate, EndDate, ProjectID, ParentTaskID, Label) VALUES
  ('Hoàn thiện thiết kế UI', 'Chốt giao diện cuối cùng', 3, 'Cao', '2023-02-20 08:00:00', '2023-02-22 17:00:00', 2, NULL, 'UI'),
  ('Kiểm thử chức năng thanh toán', 'Test mọi kịch bản thanh toán', 3, 'Trung Bình', '2023-03-16 08:00:00', '2023-03-20 17:00:00', 2, NULL, 'Testing');